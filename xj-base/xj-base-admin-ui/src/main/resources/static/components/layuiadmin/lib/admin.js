        ...
        , admin = {
            ...
            , theme: function (options) {
                var theme = setter.theme
                    ...
                    , '.layadmin-side-shrink .layui-side-menu .layui-nav>.layui-nav-item>',
                ...
                styleElem && $body[0].removeChild(styleElem); // 先重置页面
                $body[0].appendChild(style); // 把style dom节点添加在里面
                $body.attr('layadmin-themealias', options.color.alias); // 添加值
