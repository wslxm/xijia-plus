...
public class MenuController extends BaseController<MenuService> {
    ...
    public R<List<MenuVO>> list(@ModelAttribute MenuQuery query) {
    ...
    public R<String> insert(@RequestBody MenuDTO dto) {
    ...
    public R<Boolean> upd(@PathVariable String id, @RequestBody MenuDTO dto) {
