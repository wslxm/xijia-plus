...
public class LogController extends BaseController<LogService> {
     ...
     *
     * @param query
     * @return io.github.wslxm.springbootplus2.core.result.Result<com.baomidou.mybatisplus.core.metadata.IPage < io.github.wslxm.springbootplus2.manage.sys.model.vo.LogVO>>
     * @author wangsong
     */
