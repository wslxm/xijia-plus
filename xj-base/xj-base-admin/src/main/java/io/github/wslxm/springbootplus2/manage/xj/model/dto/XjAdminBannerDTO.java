package io.github.wslxm.springbootplus2.manage.xj.model.dto;
...
@ApiModel(value = "XjAdminBannerDTO 对象", description = "banner表")
public class XjAdminBannerDTO extends Convert {
