package com.github.wslxm.springbootplus2.manage.gc.config;
...
public class GenerateConfig {
    ...
    // public static String PACK_PATH_GC;     //  生成代码的包名/路径（从java 目录开始，如当前: com.github.wslxm.modules）
     ...
     * 3、packName;          // 生成代码的包名/路径 （从java 目录开始，如当前: com.github.wslxm.baseadmin）
     * 4、pathTp;            // 代码模板路径
     */
