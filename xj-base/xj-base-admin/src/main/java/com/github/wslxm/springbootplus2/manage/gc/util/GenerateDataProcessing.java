package com.github.wslxm.springbootplus2.manage.gc.util;


import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.github.wslxm.springbootplus2.manage.gc.config.GenerateConfig;
import com.google.common.base.CaseFormat;
import com.github.wslxm.springbootplus2.core.utils.LocalDateTimeUtil;
...
public class GenerateDataProcessing {
     ...
     *  {packName} ：     生成代码的包名/路径 （从java 目录开始，如当前: com.github.wslxm.baseadmin）
     *  {tableName} ：    数据库表的实际名称
     *  {entryName} ：    项目名实际名称
