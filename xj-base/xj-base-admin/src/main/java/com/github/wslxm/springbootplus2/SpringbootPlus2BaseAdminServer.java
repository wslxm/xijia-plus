package com.github.wslxm.springbootplus2;
 ...
 * @version 1.0.0
 */
@SpringBootApplication(scanBasePackages = { "com.github.wslxm.springbootplus2"})//,exclude = DruidDataSourceAutoConfigure.class
@MapperScan({"com.github.wslxm.springbootplus2.*.*.mapper"})
