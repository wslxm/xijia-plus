package com.github.wslxm.springbootplus2.manage.xj.model.entity;
...
@TableName("t_xj_admin_config")
@ApiModel(value = "XjAdminConfig 对象", description = "系统全局数据信息配置表")
public class XjAdminConfig extends BaseEntity {
