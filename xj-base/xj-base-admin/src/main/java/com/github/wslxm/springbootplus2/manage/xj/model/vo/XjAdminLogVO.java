package com.github.wslxm.springbootplus2.manage.xj.model.vo;
...
@ApiModel(value = "XjAdminLogVO 对象", description = "操作记录表")
public class XjAdminLogVO extends BaseVo {
    ...
    @ApiModelProperty(notes = "操作时间" ,position = 19)
