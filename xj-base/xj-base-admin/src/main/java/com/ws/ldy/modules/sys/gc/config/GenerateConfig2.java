...
//    public static String TABLE_PREFIX = GenerateConfig2.TABLE_PREFIX_DEFAULT;
//    public static String FIELD_PREFIX = GenerateConfig2.FIELD_PREFIX_DEFAULT;
//
//    /**
//     * 生成路径
//     * 相对路径： value=""  当前项目目录下(默认为相对路径)
