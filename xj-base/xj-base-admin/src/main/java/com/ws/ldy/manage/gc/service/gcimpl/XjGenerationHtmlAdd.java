...
import com.ws.ldy.manage.gc.template.*;
...
@Component
public class XjGenerationHtmlAdd extends BaseIServiceImpl implements XjGenerationSevice {
    ...
    public void run(List<Map<String, Object>> dataList, String path) {
        ...
        // url保存
        XjGenerateController.pathMap.put("mainAdd", getBaseUrl(request) +"/" +brBwPath.get("path").toString());
    }
