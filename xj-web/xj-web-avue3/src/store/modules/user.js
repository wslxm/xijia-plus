...
import {getUserInfo, loginByUsername, logout, refeshToken} from '@/api/user'
    ...
    actions: {
        ...
        LoginByUsername({commit}, userInfo = {}) {
            ...
            return new Promise((resolve) => {
                loginByUsername(user.username, userInfo.password, userInfo.code, userInfo.redomStr).then(res => {
