...
-- ----------------------------
INSERT INTO `t_admin_authority` VALUES (72, 78, 'user:delete', '/userAdmin/delete', '删除', 'POST');
INSERT INTO `t_admin_authority` VALUES (73, 78, 'user:save', '/userAdmin/save/{type}', '添加/修改', 'POST');
INSERT INTO `t_admin_authority` VALUES (74, 78, 'user:login', '/userAdmin/login', '登录', 'POST');
INSERT INTO `t_admin_authority` VALUES (75, 78, 'user:updPwd', '/userAdmin/updPwd', '密码修改', 'POST');
INSERT INTO `t_admin_authority` VALUES (76, 78, 'user:findAll', '/userAdmin/findAll/{type}', '查询', 'GET');
INSERT INTO `t_admin_authority` VALUES (78, 0, 'userAdmin', '/userAdmin', '系统用户', NULL);
