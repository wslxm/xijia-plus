...
INSERT INTO `t_xj_admin_blacklist` VALUES ('1332337401510551554', NULL, NULL, '2020-11-27 22:56:02', '2020-11-28 02:34:24', 0, 0, 2, '*', '禁止所有 ip 访问,除本地 [127.${.version} / localhost] ,不建议配置在所有资源上，一旦配置，所有用户(包括自己) 将无法访问所有资源，因为每个用户的ip地址都不一样， 开启此功能需提前配置所有用户的ip地址为白名单', 1);
INSERT INTO `t_xj_admin_blacklist` VALUES ('1332374043059408898', NULL, NULL, '2020-11-28 01:21:40', '2020-11-28 02:16:08', 1, 0, 1, '127.${.version}', '本地ip', 0);
...
-- ----------------------------
INSERT INTO `t_xj_admin_datasource` VALUES ('1323947589577543681', NULL, NULL, '2020-11-04 19:17:56', '2020-11-05 10:23:22', 0, 0, 'office-live本地', 'db_workspace', '127.${.version}:3306', 'root', '123456', 't_', NULL, '1', '1', '1', '1');
