package com.ws.ldy.others.wechat.auth.util;
...
public class WeChetH5AuthUtil {
    ...
    public String getAuthCodeUrl(Integer type, String callback) {
        ...
        // 拼接url
        return WxChatConstant.AuthUrl.AUTH_CODE_URL
    ...
    public String getOpenId(String code) {
        ...
        String url = WxChatConstant.AuthUrl.AUTH_ACCESS_TOKEN_URL
                .replace("APPID", wxMpProperties.getConfigs().get(0).getAppId())
                .replace("SECRET", wxMpProperties.getConfigs().get(0).getSecret())
                .replace("CODE", code);
