package com.ws.ldy.others.wechat.pay.controller;
...
@RestController
@AllArgsConstructor
@Api(value = "WebsocketController", tags = "v-1.6 -- 微信支付", consumes = BaseConstant.InterfaceType.PC_BASE)
@RequestMapping(BaseConstant.Sys.API + "/pay")
...
//    }
    ...
    public R<WxPayMpOrderResultVO> createOrder(@RequestBody WxPayUnifiedOrderDTO dto) throws WxPayException {
        WxPayMpOrderResultVO vo = this.xjWxPayService.createOrder(dto);
        return R.success(vo);
    }
    ...
    @PostMapping("/refund")
    public R<WxRefundResultVO> refund(@RequestBody WxPayRefundDTO dto) throws WxPayException {
        return R.success(this.xjWxPayService.refund(dto));
    }
