package com.ws.ldy.others.wechat.mq.util;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ws.ldy.config.error.ErrorException;
import com.ws.ldy.others.wechat.mq.config.WxMpConfig;
import com.ws.ldy.others.wechat.mq.config.WxMqUrl;
...
public class WeChetH5AuthUtil {
     ...
     */
    public String getAuthCodeUrl(Integer type, String callback) {
        try {
        ...
        // 拼接url
        return WxMqUrl.AuthUrl.AUTH_CODE_URL
                .replace("APPID", WxMpConfig.appId)
    ...
    public String getOpenId(String code) {
        ...
        String url = WxMqUrl.AuthUrl.AUTH_ACCESS_TOKEN_URL
                .replace("APPID", WxMpConfig.appId)
                .replace("SECRET", WxMpConfig.secret)
                .replace("CODE", code);
        ...
        if (errcode != null) {
            ...
            throw new ErrorException(Integer.valueOf(errcode.toString()), jsonObject.get("errmsg").toString());
        }
