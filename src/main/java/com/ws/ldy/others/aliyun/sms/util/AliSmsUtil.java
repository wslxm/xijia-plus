package com.ws.ldy.others.aliyun.sms.util;
...
import com.ws.ldy.others.aliyun.sms.smsTemplate.SmsTemplate;
...
public class AliSmsUtil {
    ...
    public static final String accessKeyId = "";      //请在阿里云短信控制台获取
    public static final String accessKeySecret = "";   //请在阿里云短信控制台获取
