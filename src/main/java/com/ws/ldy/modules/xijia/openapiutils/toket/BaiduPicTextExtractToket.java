package com.ws.ldy.modules.xijia.openapiutils.toket;
 ...
 * 百度文字提取toket 获取工具类
 */
public class BaiduPicTextExtractToket {
    ...
    private final static String clientId = "3671xuH3f8w5Pwt99v6X3I2D";
    private final static String clientSecret = "oY7GsIEDfIFgMh8bZkirtpAvtdbHDzYR";
