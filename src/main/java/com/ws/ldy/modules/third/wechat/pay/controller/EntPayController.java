...
import com.ws.ldy.modules.third.wechat.pay.wxApi.EntPayApi;
...
@RestController
@AllArgsConstructor
@Api(value = "WebsocketController", tags = "WX  -->  微信企业付款",consumes = BaseConstant.InterfaceType.PC_BASE)
@RequestMapping(BaseConstant.Sys.API + "/entPay")
