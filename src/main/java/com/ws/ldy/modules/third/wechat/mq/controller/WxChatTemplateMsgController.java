...
import com.ws.ldy.modules.third.wechat.mq.service.WxChatTemplateMsgService;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Sys.API + "/wechat/template/msg")
@Api(value = "WxChatTemplateMsgController", tags = "WX  -->  微信模板消息推送",consumes = BaseConstant.InterfaceType.PC_BASE)
