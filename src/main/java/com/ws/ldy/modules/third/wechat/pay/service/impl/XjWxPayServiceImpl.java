package com.ws.ldy.modules.third.wechat.pay.service.impl;
...
public class XjWxPayServiceImpl implements XjWxPayService {
     ...
     */
    @Override
    public WxPayOrderResultVO createOrder(WxPayOrderDTO dto) {
     ...
     */
    @Override
    public WxPayRefundResultVO refund(WxPayRefundDTO dto) {
     ...
     */
    @Override
    public WxPayOrderNotifyResultVO parseOrderNotifyResult(String xmlData) {
