...
public class WxAppSubscribeUtil {
     ...
     * @version 1.0.0
     */
    private String sendMsg(String openId, String templateId, Map<String, WxAppMsg> data) {
        String accessToken = wxAppAccessTokenUtil.getToken();
     ...
     * @return
     */
    public String payMsg(String openId, String userName, String productName, BigDecimal amount, String time) {
        // 模板Id
        ...
        // 发送
        String res = sendMsg(openId, templateId, sendMag);
        return res;
    }
     ...
     *  @return
     */
    public String checkMsg(String openId, String checkContent, String checkTime, String checkResult, String remark) {
        // 模板Id
     ...
     * @return
     */
    public String feedbackCheckMsg(String openId, String feedbackContent, String replyContent) {
        // 模板Id
