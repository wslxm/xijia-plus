package com.ws.ldy.modules.business.pay.controller;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Sys.API + "/pay/payRecord")
@Api(value = "PayRecordController", tags = "pay  -->  第三方支付记录", consumes = BaseConstant.InterfaceType.PC_ADMIN)
