...
import com.ws.ldy.modules.gc.model.dto.XjGenerateDto;
...
import com.ws.ldy.modules.gc.service.impl.XjGenerationSeviceImpl;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Sys.API + "/generate")
@Api(value = "XjGenerateController", tags = "base-plus--代码生成", consumes = BaseConstant.InterfaceType.PC_ADMIN)
