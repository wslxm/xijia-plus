...
import com.ws.ldy.modules.xj.model.entity.XjAdminBlacklist;
import com.ws.ldy.modules.xj.model.vo.XjAdminBlacklistVO;
...
import com.ws.ldy.modules.xj.model.dto.XjAdminBlacklistDTO;
import com.ws.ldy.modules.xj.service.XjAdminBlacklistService;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Sys.API + "/admin/adminBlacklist")
@Api(value = "XjAdminBlacklistController", tags = "base-plus--黑名单", consumes = BaseConstant.InterfaceType.PC_ADMIN)
