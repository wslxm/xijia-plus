...
import com.ws.ldy.modules.xj.model.dto.XjAdminBannerDTO;
import com.ws.ldy.modules.xj.model.entity.XjAdminBanner;
import com.ws.ldy.modules.xj.model.vo.XjAdminBannerVO;
import com.ws.ldy.modules.xj.service.XjAdminBannerService;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Sys.API + "/admin/adminBanner")
@Api(value = "XjAdminBannerController", tags = "base-plus--banner", consumes = BaseConstant.InterfaceType.PC_ADMIN)
