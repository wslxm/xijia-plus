package com.ws.ldy.modules.astory.controller;
...
import com.ws.ldy.modules.astory.model.dto.XjAstoryCategoryDTO;
import com.ws.ldy.modules.astory.model.entity.XjAstoryCategory;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Sys.URI_PREFIX + "/astory/xjAstoryCategory")
@Api(value ="XjAstoryCategoryController" ,tags = "段子分类表", consumes = BaseConstant.InterfaceType.PC_ADMIN)
