...
public class GenerateConfig {
    ...
    public final static String BASE_PATH_HTML_TXT_YL = "File/code/src/main/resources/templates/" + ROOT_MODULE + "/" + PACK_PATH_ZP + "/" + MODULE_NAME + "/txt/";
    public final static String BASE_PATH_JAVA_YL = "File/code/src/main/java/" + (PACK_PATH+"."+ROOT_MODULE).replace(".", "/") + "/" + PACK_PATH_ZP + "/" + MODULE_NAME + "/";
    public final static String BASE_PATH_XML_YL = "File/code/src/main/resources/mapper/" + ROOT_MODULE + "/" + PACK_PATH_ZP + "/" + MODULE_NAME + "/";

    // 生成的 html + java代码生成路径拼接 --> 父工程绝对路径 + 包路径 + 包的下一级路径+ 模块名
    public final static String BASE_PATH_HTML = "src/main/resources/templates/" + ROOT_MODULE + "/" + PACK_PATH_ZP + "/" + MODULE_NAME + "/";
    public final static String BASE_PATH_JAVA = "src/main/java/" + (PACK_PATH+"."+ROOT_MODULE).replace(".", "/") + "/" + PACK_PATH_ZP + "/" + MODULE_NAME.replace(".", "/") + "/";
    public final static String BASE_PATH_XML = "src/main/resources/mapper/" + ROOT_MODULE + "/" + PACK_PATH_ZP + "/" + MODULE_NAME + "/";
    ;
