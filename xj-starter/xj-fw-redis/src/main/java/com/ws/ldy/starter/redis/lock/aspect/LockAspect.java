package com.ws.ldy.starter.redis.lock.aspect;


import com.ws.ldy.starter.redis.lock.annotation.SynchronizedLock;
import com.ws.ldy.starter.redis.lock.annotation.TaskLock;
import com.ws.ldy.starter.redis.lock.util.RedisLockUtil;
import com.ws.ldy.starter.redis.error.RedisErrorException;
...
public class LockAspect {
     ...
     * @version 1.0.0
     */
    @Around("execution(* *.*(..)) && @annotation(com.ws.ldy.starter.redis.lock.annotation.TaskLock)")
     ...
     * @version 1.0.0
     */
    @Around("@annotation(com.ws.ldy.starter.redis.lock.annotation.SynchronizedLock)")
