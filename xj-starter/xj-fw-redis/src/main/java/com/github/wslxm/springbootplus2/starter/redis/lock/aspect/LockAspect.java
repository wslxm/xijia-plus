package com.github.wslxm.springbootplus2.starter.redis.lock.aspect;


import com.github.wslxm.springbootplus2.starter.redis.error.RedisErrorException;
import com.github.wslxm.springbootplus2.starter.redis.lock.annotation.SynchronizedLock;
import com.github.wslxm.springbootplus2.starter.redis.lock.annotation.TaskLock;
import com.github.wslxm.springbootplus2.starter.redis.lock.util.RedisLockUtil;
...
public class LockAspect {
     ...
     * @version 1.0.0
     */
    @Around("execution(* *.*(..)) && @annotation(com.github.wslxm.springbootplus2.starter.redis.lock.annotation.TaskLock)")
     ...
     * @version 1.0.0
     */
    @Around("@annotation(com.github.wslxm.springbootplus2.starter.redis.lock.annotation.SynchronizedLock)")
