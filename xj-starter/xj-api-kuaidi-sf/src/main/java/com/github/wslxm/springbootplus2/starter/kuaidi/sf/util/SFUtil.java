package com.github.wslxm.springbootplus2.starter.kuaidi.sf.util;

import com.alibaba.fastjson.JSON;
import com.github.wslxm.springbootplus2.core.result.R;
import com.github.wslxm.springbootplus2.starter.kuaidi.sf.config.SFProperties;
import com.github.wslxm.springbootplus2.starter.kuaidi.sf.entity.placeAnOrder.base.ApiResultData;
import com.github.wslxm.springbootplus2.starter.kuaidi.sf.entity.placeAnOrder.base.SFReturnData;
...
public class SFUtil {
     ...
     * @return SFReturnData
     */
    public R<String> http(String serviceCode, String mgsData) {
        ...
        if (!"A1000".equals(sfReturnData.getApiResultCode())) {
            ...
            return R.error(10099, sfReturnData.getApiErrorMsg());
        }
        // 请求成功判断验证是否通过
        ...
        if (!apiResultData.isSuccess()) {
            //失败
            log.info(sfReturnData.toString());
            return R.error(10099, apiResultData.getErrorMsg());
        }
        return R.success(apiResultData.getMsgData());
    }
