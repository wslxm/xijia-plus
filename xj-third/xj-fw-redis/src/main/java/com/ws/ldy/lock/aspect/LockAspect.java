package com.ws.ldy.lock.aspect;


import com.ws.ldy.config.error.RedisErrorException;
import com.ws.ldy.lock.annotation.SynchronizedLock;
import com.ws.ldy.lock.annotation.TaskLock;
import com.ws.ldy.lock.util.RedisLockUtil;
...
public class LockAspect {
     ...
     * @version 1.0.0
     */
    @Around("execution(* *.*(..)) && @annotation(com.ws.ldy.lock.annotation.TaskLock)")
     ...
     * @version 1.0.0
     */
    @Around("@annotation(com.ws.ldy.lock.annotation.SynchronizedLock)")
