 ...
 */
@RestController
@RequestMapping("/api/wx/mq")
@Api(value = "WeChetH5AuthController", tags = "WX  -->  微信网页授权")
public class WeChetH5AuthController {
    ...
    public R<String> getAuthCodeUrl(@RequestParam Integer type, String callback) {
        return weChetH5AuthUtil.getAuthCodeUrl(type, callback);
    }
    ...
    public R<String> getOpenId(@RequestParam String code) {
        return weChetH5AuthUtil.getOpenId(code);
    }
