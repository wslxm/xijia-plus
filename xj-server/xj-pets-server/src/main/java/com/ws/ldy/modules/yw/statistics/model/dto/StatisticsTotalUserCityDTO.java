...
@ApiModel(value = "StatisticsTotalUserCityDTO 对象", description = "用户城市总量表(每小时一次)")
public class StatisticsTotalUserCityDTO extends BaseDto {

    private static final long serialVersionUID = -503730135560753154L;
    ...
    @Range(min=0, max=7766279631452241920L,message = "当前城市人总数 必须>=0 和 <=7766279631452241920")
