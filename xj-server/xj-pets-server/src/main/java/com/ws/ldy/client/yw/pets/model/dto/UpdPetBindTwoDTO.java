...
@ApiModel(value = "UpdPetBindTwoDTO", description = "宠物绑定2")
public class UpdPetBindTwoDTO extends Convert {
    private static final long serialVersionUID = -2573721444202495869L;
    ...
    @ApiModelProperty(notes = "类型1+2参数---新临时宠物id(支付完成没有立即绑定，生成的新宠物数据)", position = 1)
    @NotBlank
