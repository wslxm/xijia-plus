...
import com.ws.ldy.modules.yw.astory.model.dto.XjAstoryDTO;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Uri.apiAdmin + "/astory/xjAstory")
@Api(value = "XjAstoryController", tags = "独立功能--段子")
