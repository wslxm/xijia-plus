...
public class WxPayServiceImpl implements PayService {
    ...
    public String orderCallback(String xmlData) {
        ...
        payRecordService.updStateAndCallbackData(outTradeNo, Enums.Pay.PayState.PAY_STATE_1.getValue(), callbackData);
        ...
        if (!moneyTotal.equals(wxPayOrderNotifyResultVO.getTotalFee())
            ...
            Boolean result = payRecordService.updStateAndCallbackData(outTradeNo, Enums.Pay.PayState.PAY_STATE_2.getValue(), callbackData);
            ...
            Boolean result = payRecordService.updStateAndCallbackData(outTradeNo, Enums.Pay.PayState.PAY_STATE_3.getValue(), callbackData);
            return WxPayNotifyResponse.success("ok");
        }
    }
