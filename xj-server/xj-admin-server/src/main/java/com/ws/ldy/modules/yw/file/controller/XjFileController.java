package com.ws.ldy.modules.yw.file.controller;
...
import com.ws.ldy.modules.yw.file.model.dto.XjFileDTO;
import com.ws.ldy.modules.yw.file.model.entity.XjFile;
import com.ws.ldy.modules.yw.file.model.vo.XjFileVO;
import com.ws.ldy.modules.yw.file.service.XjFileService;
 ...
 */
@RestController
@RequestMapping(BaseConstant.Uri.apiAdmin + "/file/xjFile")
@Api(value ="XjFileController" ,tags = "独立功能--常用工具文件管理")
