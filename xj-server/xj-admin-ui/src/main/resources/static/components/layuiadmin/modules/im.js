    ...
    var $ = layui.jquery, active = {
        chat: function () {
            ...
            layim.chat({
                name: '小闲'
                , type: 'friend'
                , avatar: '//tva3.sinaimg.cn/crop.${.version}80.180.180/7f5f6861jw1e8qgp5bmzyj2050050aa8.jpg'
                , id: 1008612
            });
        ...
        , addqun: function () {
            layim.add({
                type: 'group'
                , username: 'LayIM会员群'
                , avatar: '//tva2.sinaimg.cn/crop.${.version}80.180.50/6ddfa27bjw1e8qgp5bmzyj2050050aa8.jpg'
                , submit: function (group, remark, index) {
