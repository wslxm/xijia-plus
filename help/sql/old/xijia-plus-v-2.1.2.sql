...
CREATE TABLE `t_gc_test`  (
  ...
  `head_url` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单图文件',
  `head_files` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '多图文件 (多图-默认限制10张图片, 字符串分割存储)',
  `video_files` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视频文件 (视频-默认多上传)',
  `files` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '任意文件 (任意文件上传-默认多上传)',
  `time` datetime(0) DEFAULT NULL COMMENT '时间 (默认 yyyy-MM-dd hh:mm:ss 格式)',
  `time_two` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '时间-小时 (默认 hh:mm 字串)',
  `text` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更多信息-text (大文本)',
  `text_two` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '更多信息-fwb (富文本)',
  `text_three` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '更多信息-md (md编辑器)',
  `cascader` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '级联选择器  (字符串分割存储)',
  `array` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '数组框 (字符串分割存储)',
  `icon` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图标 ',
  `color` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '颜色选择器',
  `map` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '地址选择器',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `t_gc_test` VALUES ('1568185006784897026', NULL, NULL, '2022-09-09 18:30:16', '2022-09-09 18:33:18', 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '#C71585', '120.11669741258027,30.28989139415141,浙江省杭州市西湖区古荡街道天堂软件园南区');
INSERT INTO `t_gc_test` VALUES ('1568185740393791489', NULL, NULL, '2022-09-09 18:33:11', '2022-09-09 18:33:31', 0, 0, '小二', 25.00, 1, '2,3', 2, 0, 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/file/gc/img/54265860-20.jpg', 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/file/gc/img/58930081-timg(3).jpg,http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/file/gc/img/58917931-timg(4).jpg', 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/file/gc/video/09100766-女主-被医生按倒-不要!-18.08s.mp4', 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/file/gc/all/07038710-timg(8).jpg,http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/file/gc/all/07038917-timg(9).jpg', '2022-09-09 06:32:28', '07:00', '啦啦啦', '<p>啦啦啦</p>', '啦啦啦', '1,2,3', '1,2', 'el-icon-s-promotion', '#FF4500', '120.1678525029123,30.28485154849538,浙江省杭州市拱墅区朝晖街道浙江省人民医院浙江省人民医院(朝晖院区)');
...
-- ----------------------------
INSERT INTO `t_sys_authority` VALUES ('697255086296010752', NULL, '0', '2022-06-21 11:29:37', '2022-06-21 11:29:37', 0, 309, '0', '', '/api/open/redis', 'Redis  -->  Redis 测试', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('697398103711551488', NULL, '0', '2022-06-21 12:57:58', '2022-06-21 12:57:58', 0, 307, '697255086296010752', 'GET', '/api/open/redis/redissonDistributedLockTest2/{key}', 'redis 分布式锁加锁测试2', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('697398103711551489', NULL, '0', '2022-06-21 12:57:58', '2022-06-21 12:57:58', 0, 307, '697255086296010752', 'GET', '/api/open/redis/redissonDistributedLockTest1/{key}', 'redis 分布式锁加锁测试', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('697398103711551490', NULL, '0', '2022-06-21 12:57:58', '2022-06-21 12:57:58', 0, 307, '697255086296010752', 'GET', '/api/open/redis/redissonDistributedLockTest3', 'redis 分布式注解锁测试', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('700879734145421312', NULL, '0', '2022-06-29 11:32:41', '2022-09-07 10:19:31', 0, 273, '0', '', '/api/admin/test/gcTest', '代码生成测试表', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('700879734145421314', NULL, '0', '2022-06-29 11:32:41', '2022-09-07 10:19:32', 0, 273, '700879734145421312', 'POST', '/api/admin/test/gcTest', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('700879734145421315', NULL, '0', '2022-06-29 11:32:41', '2022-09-07 10:19:32', 0, 273, '700879734145421312', 'DELETE', '/api/admin/test/gcTest/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('700879734149615616', NULL, '0', '2022-06-29 11:32:41', '2022-09-07 10:19:33', 0, 273, '700879734145421312', 'PUT', '/api/admin/test/gcTest/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('700879734149615617', NULL, '0', '2022-06-29 11:32:41', '2022-09-07 10:19:33', 0, 273, '700879734145421312', 'GET', '/api/admin/test/gcTest/{id}', 'ID查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('720779973740335104', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '0', '', '/api/open/websocket', 'Websocket  -->  消息通知/即时通讯', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973740335105', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973740335104', 'GET', '/api/open/websocket/getPath', '获取模拟游客登录的 websocket 连接地址', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973740335106', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973740335104', 'POST', '/api/open/websocket/send', '发送消息', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973740335107', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973740335104', 'GET', '/api/open/websocket/getOnlineUsersList', '获取当前在线用户列表', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973740335108', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973740335104', 'GET', '/api/open/websocket/getOnlineCount', '获取在线人数', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973761306624', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '0', '', '/api/open/aliOssFile', 'AliYun --> OSS文件管理', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973761306625', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973761306624', 'POST', '/api/open/aliOssFile/upload', 'OSS-文件上传,可在指定路径后追加子路径,以/结尾，返回完整可访问当前服务内网访问OSS的完整URL', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973761306626', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973761306624', 'DELETE', '/api/open/aliOssFile/del', 'OSS-文件删除', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973761306627', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973761306624', 'GET', '/api/open/aliOssFile/fileList', 'OSS-文件Object列表', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973761306628', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973761306624', 'GET', '/api/open/aliOssFile/downloadZip', 'OSS-文件下载--多文件下载', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('720779973761306629', NULL, NULL, '2022-08-21 17:29:10', '2022-08-21 17:29:10', 0, 137, '720779973761306624', 'GET', '/api/open/aliOssFile/download', 'OSS-文件下载--单文件下载', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('721146444106567680', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:33', 0, 115, '0', '', '/api/admin/sys/user', 'base--sys--用户管理', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444106567681', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:33', 0, 115, '721146444106567680', 'POST', '/api/admin/sys/user', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444106567682', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:33', 0, 115, '721146444106567680', 'GET', '/api/admin/sys/user/{id}', 'ID查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444106567683', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:34', 0, 115, '721146444106567680', 'PUT', '/api/admin/sys/user/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761984', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:34', 0, 115, '721146444106567680', 'DELETE', '/api/admin/sys/user/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761985', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:34', 0, 115, '721146444106567680', 'GET', '/api/admin/sys/user/findPage', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761986', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:35', 0, 115, '721146444106567680', 'PUT', '/api/admin/sys/user/{id}/resetPassword', '重置任意用户密码', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761987', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:35', 0, 115, '721146444106567680', 'PUT', '/api/admin/sys/user/updByPassword', '修改当前登录人的密码', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761988', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:35', 0, 115, '721146444106567680', 'GET', '/api/admin/sys/user/findByRoleId', '获取指定角色的用户列表', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761989', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:35', 0, 115, '721146444106567680', 'GET', '/api/admin/sys/user/findUser', '查询当前登录人的个人信息', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761990', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:36', 0, 115, '721146444106567680', 'PUT', '/api/admin/sys/user/updUser', '修改当前登录人的信息', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761991', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:36', 0, 115, '721146444106567680', 'GET', '/api/admin/sys/user/list/keyData', '查询所有-只返回关键数据(姓名/昵称/电话/id)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444110761992', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:36', 0, 115, '721146444106567680', 'POST', '/api/admin/sys/user/login', '用户登录', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956288', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:36', 0, 115, '0', '', '/api/admin/sys/dictionary', 'base--sys--字典管理', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956289', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:36', 0, 115, '721146444114956288', 'GET', '/api/admin/sys/dictionary/list', '列表查询 (默认返回Tree数据,可指定Tree或List)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956290', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:37', 0, 115, '721146444114956288', 'POST', '/api/admin/sys/dictionary', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956291', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:37', 0, 115, '721146444114956288', 'PUT', '/api/admin/sys/dictionary/{id}', '编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956292', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:37', 0, 115, '721146444114956288', 'DELETE', '/api/admin/sys/dictionary/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956293', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:37', 0, 115, '721146444114956288', 'GET', '/api/admin/sys/dictionary/findCodeGroup', '查询所有-code分组', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444114956294', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:37', 0, 115, '721146444114956288', 'GET', '/api/admin/sys/dictionary/generateEnum', '生成枚举', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444119150592', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:37', 0, 115, '721146444114956288', 'GET', '/api/admin/sys/dictionary/list/category', '获取类别(级联数据)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444119150593', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:38', 0, 115, '0', '', '/api/admin/sys/dep', 'base--sys--组织机构', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444119150594', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:38', 0, 115, '721146444119150593', 'GET', '/api/admin/sys/dep/list', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444119150595', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:38', 0, 115, '721146444119150593', 'POST', '/api/admin/sys/dep', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444119150596', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:38', 0, 115, '721146444119150593', 'PUT', '/api/admin/sys/dep/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444119150597', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:38', 0, 115, '721146444119150593', 'DELETE', '/api/admin/sys/dep/{id}', 'ID删除(并删除子数据)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444123344896', NULL, NULL, '2022-08-22 17:45:22', '2022-08-22 17:45:22', 0, 115, '0', '', '/api/client/sys/dictionary', 'yh--base--字典管理', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721146444123344897', NULL, NULL, '2022-08-22 17:45:22', '2022-08-22 17:45:22', 0, 115, '721146444123344896', 'GET', '/api/client/sys/dictionary/findByCode', 'Code查询(Tree)', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721146444123344898', NULL, NULL, '2022-08-22 17:45:22', '2022-08-22 17:45:22', 0, 115, '721146444123344896', 'GET', '/api/client/sys/dictionary/findCodeGroup', '查询所有-code分组', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721146444123344899', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:39', 0, 115, '0', '', '/api/admin/sys/menu', 'base--sys--菜单管理', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444123344900', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:39', 0, 115, '721146444123344899', 'GET', '/api/admin/sys/menu/list', '列表查询(不支持分页)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444123344901', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:39', 0, 115, '721146444123344899', 'POST', '/api/admin/sys/menu', '菜单添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444123344902', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:39', 0, 115, '721146444123344899', 'PUT', '/api/admin/sys/menu/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444123344903', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:39', 0, 115, '721146444123344899', 'DELETE', '/api/admin/sys/menu/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444123344904', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:39', 0, 115, '721146444123344899', 'GET', '/api/admin/sys/menu/findTree', '左导航菜单', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444131733504', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:40', 0, 115, '0', '', '/api/admin/sys/role', 'base--sys--角色管理', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444131733505', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:40', 0, 115, '721146444131733504', 'POST', '/api/admin/sys/role', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444131733506', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:40', 0, 115, '721146444131733504', 'PUT', '/api/admin/sys/role/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444131733507', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:40', 0, 115, '721146444131733504', 'DELETE', '/api/admin/sys/role/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444131733508', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:40', 0, 115, '721146444131733504', 'GET', '/api/admin/sys/role/findPage', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444135927808', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:40', 0, 115, '0', '', '/api/admin/sys/blacklist', 'base--sys--黑名单', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444135927809', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:41', 0, 115, '721146444135927808', 'POST', '/api/admin/sys/blacklist', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444135927810', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:41', 0, 115, '721146444135927808', 'PUT', '/api/admin/sys/blacklist/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444135927811', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:41', 0, 115, '721146444135927808', 'DELETE', '/api/admin/sys/blacklist/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444135927812', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:41', 0, 115, '721146444135927808', 'GET', '/api/admin/sys/blacklist/findPage', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444140122112', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:41', 0, 115, '0', '', '/api/admin/sys/authority', 'base--sys--URL权限管理', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444140122113', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:42', 0, 115, '721146444140122112', 'GET', '/api/admin/sys/authority/list', '查询所有-接口管理', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444140122114', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:42', 0, 115, '721146444140122112', 'PUT', '/api/admin/sys/authority/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444140122115', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:42', 0, 115, '721146444140122112', 'PUT', '/api/admin/sys/authority/refreshAuthority', '扫描权限', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316416', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:42', 0, 115, '0', '', '/api/admin/sys/config', 'base--sys--全局配置', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316417', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:43', 0, 115, '721146444144316416', 'POST', '/api/admin/sys/config', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316418', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:43', 0, 115, '721146444144316416', 'GET', '/api/admin/sys/config/{id}', 'ID查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316419', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:43', 0, 115, '721146444144316416', 'PUT', '/api/admin/sys/config/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316420', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:43', 0, 115, '721146444144316416', 'DELETE', '/api/admin/sys/config/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316421', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:43', 0, 115, '721146444144316416', 'GET', '/api/admin/sys/config/findPage', '分页查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721146444144316422', NULL, NULL, '2022-08-22 17:45:22', '2022-09-07 10:19:43', 0, 115, '721146444144316416', 'GET', '/api/admin/sys/config/findByCode', 'CODE查询', 0, 0, 0, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805924446208', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:43', 0, 110, '0', '', '/api/admin/gc/dataBase', 'base--gc--代码生成--查询表数据', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805928640512', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:44', 0, 110, '721151805924446208', 'GET', '/api/admin/gc/dataBase/table/list', '查询所有表名', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805928640513', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:44', 0, 110, '721151805924446208', 'GET', '/api/admin/gc/dataBase/table/field', '查询指定表下所有字段内容', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834816', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:44', 0, 110, '0', '', '/api/admin/gc/generate', 'base--gc--代码生成', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834817', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:17:46', 0, 110, '721151805932834816', 'GET', '/api/admin/gc/generate/getPath', '代码生成路径', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834818', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:44', 0, 110, '721151805932834816', 'POST', '/api/admin/gc/generate/generateCode', '生成代码', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834819', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:44', 0, 110, '721151805932834816', 'POST', '/api/admin/gc/generate/preview', '生成预览代码', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834820', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:44', 0, 110, '721151805932834816', 'POST', '/api/admin/gc/generate/generateCodeVue', '生成Vue代码(将直接下载)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834821', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:45', 0, 110, '721151805932834816', 'POST', '/api/admin/gc/generate/generateCodeJavaAndVue', '生成java + vue代码(将直接下载)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805932834822', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:45', 0, 110, '0', '', '/api/admin/gc/datasource', 'base--gc--代码生成--数据源维护', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029120', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:45', 0, 110, '721151805932834822', 'POST', '/api/admin/gc/datasource', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029121', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:45', 0, 110, '721151805932834822', 'GET', '/api/admin/gc/datasource/findPage', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029122', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:21:19', 0, 110, '721151805932834822', 'DELETE', '/api/admin/gc/datasource/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029123', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:45', 0, 110, '721151805932834822', 'PUT', '/api/admin/gc/datasource/{id}/updPwd', '修改/重置密码', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029124', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:46', 0, 110, '721151805932834822', 'GET', '/api/admin/gc/datasource/{id}', 'id查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029125', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:46', 0, 110, '721151805932834822', 'POST', '/api/admin/gc/datasource/dataSourceTest/{id}', '数据源连接测试', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721151805937029126', NULL, NULL, '2022-08-22 18:06:44', '2022-09-07 10:19:46', 0, 110, '721151805932834822', 'PUT', '/api/admin/gc/datasource/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721158911297720320', NULL, NULL, '2022-08-22 18:34:57', '2022-09-07 10:19:46', 0, 108, '0', '', '/api/admin/sys/jvm', 'base--sys--jvm信息获取', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721158911297720321', NULL, NULL, '2022-08-22 18:34:57', '2022-09-07 10:13:16', 0, 108, '721158911297720320', 'GET', '/api/admin/sys/jvm/jvmInfo', '获取系统的jvm信息', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721158911301914624', NULL, NULL, '2022-08-22 18:34:57', '2022-09-07 10:19:46', 0, 108, '0', '', '/api/admin/sys/log', 'base--sys--操作记录', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721158911301914625', NULL, NULL, '2022-08-22 18:34:57', '2022-09-07 10:19:46', 0, 108, '721158911301914624', 'GET', '/api/admin/sys/log/findPage', '分页查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721160445699952640', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '0', '', '/api/client/sys/msg', 'yh--base-plus--消息通知', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445699952641', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '721160445699952640', 'GET', '/api/client/sys/msg/findUnreadNum', '查询未读数量(当前登录用户)', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445699952642', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '721160445699952640', 'PUT', '/api/client/sys/msg/{id}/read', '消息修改为已读', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445699952643', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '721160445699952640', 'GET', '/api/client/sys/msg/findPage', '分页查询', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445729312768', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '0', '', '/api/client/sys/banner', 'yh--base-plus--banner', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445729312769', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '721160445729312768', 'GET', '/api/client/sys/banner/list/{position}', '列表-位置查询', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445733507072', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '0', '', '/api/client/sys/config', 'yh--base-plus--全局配置', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160445733507073', NULL, NULL, '2022-08-22 18:41:00', '2022-08-22 18:41:00', 0, 106, '721160445733507072', 'GET', '/api/client/sys/config/findByCode', 'CODE查询', 0, 1, 1, 0);
INSERT INTO `t_sys_authority` VALUES ('721160918934884352', NULL, NULL, '2022-08-22 18:42:53', '2022-09-07 10:19:47', 0, 105, '0', '', '/api/admin/sys/msg', 'base--sys--消息通知', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721160918934884353', NULL, NULL, '2022-08-22 18:42:53', '2022-09-07 10:19:47', 0, 105, '721160918934884352', 'POST', '/api/admin/sys/msg', '添加/发送消息', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721160918934884354', NULL, NULL, '2022-08-22 18:42:53', '2022-09-07 10:19:47', 0, 105, '721160918934884352', 'GET', '/api/admin/sys/msg/findPage', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721160918934884355', NULL, NULL, '2022-08-22 18:42:53', '2022-09-07 10:19:47', 0, 105, '721160918934884352', 'GET', '/api/admin/sys/msg/findUnreadNum', '查询未读数量(当前登录用户)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721160918934884356', NULL, NULL, '2022-08-22 18:42:53', '2022-09-07 10:19:47', 0, 105, '721160918934884352', 'PUT', '/api/admin/sys/msg/{id}/read', '消息修改为已读', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721160918934884357', NULL, NULL, '2022-08-22 18:42:53', '2022-09-07 10:19:48', 0, 105, '721160918934884352', 'GET', '/api/admin/sys/msg/findAllNum', '查询全部/已读/未读数量(当前登录用户)', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721162557955641344', NULL, NULL, '2022-08-22 18:49:22', '2022-09-07 10:19:48', 0, 103, '0', '', '/api/admin/sys/banner', 'base--sys--banner', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721162557955641345', NULL, NULL, '2022-08-22 18:49:22', '2022-09-07 10:19:48', 0, 103, '721162557955641344', 'POST', '/api/admin/sys/banner', '添加', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721162557955641346', NULL, NULL, '2022-08-22 18:49:22', '2022-09-07 10:19:49', 0, 103, '721162557955641344', 'GET', '/api/admin/sys/banner/findPage', '列表查询', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721162557955641347', NULL, NULL, '2022-08-22 18:49:22', '2022-09-07 10:19:49', 0, 103, '721162557955641344', 'DELETE', '/api/admin/sys/banner/{id}', 'ID删除', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('721162557955641348', NULL, NULL, '2022-08-22 18:49:22', '2022-09-07 10:19:49', 0, 103, '721162557955641344', 'PUT', '/api/admin/sys/banner/{id}', 'ID编辑', 0, 0, 1, 1);
INSERT INTO `t_sys_authority` VALUES ('724479128698490880', NULL, NULL, '2022-08-30 22:28:14', '2022-08-30 22:28:14', 0, 87, '697255086296010752', 'GET', '/api/open/redis/getDataNo', '获取分布式唯一数据编号', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('724479128698490881', NULL, NULL, '2022-08-30 22:28:14', '2022-08-30 22:28:14', 0, 87, '697255086296010752', 'GET', '/api/open/redis/getOrderNo', '获取分布式唯一订单号', 0, 2, 0, 0);
INSERT INTO `t_sys_authority` VALUES ('727896930335723520', NULL, NULL, '2022-09-09 00:49:24', '2022-09-09 00:49:24', 0, 28, '700879734145421312', 'GET', '/api/admin/test/gcTest/findPage', '列表查询', 0, 0, 1, 0);
...
-- ----------------------------
INSERT INTO `t_sys_config` VALUES ('1365182627308433409', NULL, '-1', '2021-02-26 14:11:17', '2022-09-01 17:28:15', 0, 0, 'login_bg_img', '背景图(登录页)', 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/image/config/20210311113615990505-1.jpg', 0, 1, '暂未使用', NULL, NULL, NULL);
...
INSERT INTO `t_sys_config` VALUES ('1564811793453887489', NULL, NULL, '2022-08-31 11:06:19', '2022-09-01 17:28:27', 0, 0, 'test', 'test', '### 123\n![image.png](http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/image/vMdEditor/26661516-image.png)\n\n```sql\nselect * from asd', 0, 4, '测试数据', '', '', '');
...
INSERT INTO `t_sys_dep` VALUES ('1548901388543594498', NULL, NULL, '2022-07-18 13:24:02', '2022-09-08 13:35:16', 0, 0, '0', 'TEST01', '测试公司1', '测试公司1的描述', 0, 0, 1);
...
INSERT INTO `t_sys_dep` VALUES ('1548901576150618114', NULL, NULL, '2022-07-18 13:24:47', '2022-08-30 14:31:23', 0, 0, '1548901468621246466', '3', '部门1_1', '部门1_1desc', 0, 0, 3);
...
INSERT INTO `t_sys_dictionary` VALUES ('1290686507555844098', NULL, '-1', '2020-08-05 00:30:17', '2022-09-08 17:15:55', 0, 0, 'ADMIN', '系统枚举(动态值)', '1290684671448936449', '-', 3, 0, NULL, NULL, NULL);
...
INSERT INTO `t_sys_dictionary` VALUES ('1352826209829978114', NULL, '-1', '2021-01-23 11:51:17', '2022-09-07 22:18:37', 0, 0, '3', 'Oauth2 接口', '1296995475064434690', '接口默认默认需通过 appId，appSecret生成的 accessToken 来进行oauth2 令牌验证可访问', 0, 1, NULL, NULL, NULL);
...
INSERT INTO `t_sys_dictionary` VALUES ('1455155390269435905', NULL, '-1', '2021-11-01 20:50:55', '2022-09-08 22:10:17', 0, 0, '10', '日期-(data)', '1455153732051349505', 'yyyy-MM-dd', 10, 1, NULL, NULL, NULL);
INSERT INTO `t_sys_dictionary` VALUES ('1455155744738455553', NULL, '-1', '2021-11-01 20:52:19', '2022-09-08 22:10:17', 0, 0, '11', '日期时间-(datetime)', '1455153732051349505', 'yyyy-MM-dd hh:mm:ss', 11, 0, NULL, NULL, NULL);
INSERT INTO `t_sys_dictionary` VALUES ('1455155995658498049', NULL, '-1', '2021-11-01 20:53:19', '2022-09-08 22:18:07', 0, 0, '12', '时间-小时选择 (time)', '1455153732051349505', '默认 hh:mm 格式，06:00 到 23::00, 步长30分钟,  如： 09::00 | 09:30', 12, 0, NULL, NULL, NULL);
INSERT INTO `t_sys_dictionary` VALUES ('1455156254728073217', NULL, '-1', '2021-11-01 20:54:21', '2022-09-08 22:14:41', 0, 0, '6', '下拉选择-(select-单选)', '1455153732051349505', '-默认支持搜索', 6, 0, NULL, NULL, NULL);
...
INSERT INTO `t_sys_dictionary` VALUES ('1455158056173252609', NULL, '-1', '2021-11-01 21:01:30', '2022-09-08 17:18:36', 0, 0, '13', '文件上传 (单图)', '1455153732051349505', '默认限制 jpg/png/gif 格式', 13, 0, NULL, NULL, NULL);
INSERT INTO `t_sys_dictionary` VALUES ('1455158128055234561', NULL, '-1', '2021-11-01 21:01:47', '2022-09-08 17:17:58', 0, 0, '14', '文件上传 (多图)', '1455153732051349505', '默认限制文件数量10', 14, 0, NULL, NULL, NULL);
INSERT INTO `t_sys_dictionary` VALUES ('1455158254165372929', NULL, '-1', '2021-11-01 21:02:18', '2022-09-08 17:18:08', 0, 0, '15', '文件上传（单视频）', '1455153732051349505', '默认限制mp4格式', 15, 0, NULL, NULL, NULL);
INSERT INTO `t_sys_dictionary` VALUES ('1455160116759310338', NULL, '-1', '2021-11-01 21:09:42', '2022-09-08 17:17:43', 0, 0, '16', '文件上传（任意文件）', '1455153732051349505', '-默认限制文件数量10', 16, 0, NULL, NULL, NULL);
...
INSERT INTO `t_sys_dictionary` VALUES ('1477131575404531714', NULL, '-1', '2022-01-01 12:16:26', '2022-09-07 10:02:07', 0, 0, 'DEMO_TEST', 'demo模块测试', '1290684671448936449', '-', 1, 0, NULL, NULL, NULL);
...
INSERT INTO `t_sys_dictionary` VALUES ('1540889700338765825', NULL, NULL, '2022-06-26 10:48:27', '2022-09-08 12:33:26', 0, 0, '19', 'md编辑器 (v-md-editor)', '1455153732051349505', 'v-md-editor 插件', 19, 0, '', '', '');
INSERT INTO `t_sys_dictionary` VALUES ('1567731693815603202', NULL, NULL, '2022-09-08 12:28:57', '2022-09-08 12:29:43', 0, 0, '20', '级联选择器 (cascader)', '1455153732051349505', '需自行替换级联选择数据', 20, 0, '', '', '');
INSERT INTO `t_sys_dictionary` VALUES ('1568096167659663362', NULL, NULL, '2022-09-09 12:37:15', '2022-09-09 12:37:15', 0, 0, '21', '数组框 (array)', '1455153732051349505', '默认限制长度10, 默认内容为字符串逗号分割', 21, 0, '', '', '');
INSERT INTO `t_sys_dictionary` VALUES ('1568096550914191362', NULL, NULL, '2022-09-09 12:38:46', '2022-09-09 12:38:46', 0, 0, '22', '图标选择器 (Icon)', '1455153732051349505', '-', 22, 0, '', '', '');
INSERT INTO `t_sys_dictionary` VALUES ('1568096838635057153', NULL, NULL, '2022-09-09 12:39:55', '2022-09-09 12:39:55', 0, 0, '23', '颜色选择器 (color)', '1455153732051349505', '-', 23, 0, '', '', '');
INSERT INTO `t_sys_dictionary` VALUES ('1568097061667172353', NULL, NULL, '2022-09-09 12:40:48', '2022-09-09 12:40:48', 0, 0, '24', '地图坐标选择器 (Map)', '1455153732051349505', '-', 24, 0, '', '', '');
...
INSERT INTO `t_sys_menu` VALUES ('1457369967249879042', '1', '-1', '2021-11-07 23:30:51', '2022-09-07 10:02:23', 0, 0, '0', '商家端', NULL, NULL, 'el-icon-document-remove', 3, 1, 1);
...
INSERT INTO `t_sys_msg` VALUES ('1565226775102435329', NULL, NULL, '2022-09-01 14:35:18', '2022-09-01 14:35:18', 0, 0, 'test', '{\"routePath\":\"\",\"routePathTwo\":\"\",\"title\":\"测试消息\",\"message\":\"test\"}', 1, 0, 0);
INSERT INTO `t_sys_msg` VALUES ('1565697495314018305', NULL, NULL, '2022-09-02 21:45:46', '2022-09-02 21:45:46', 0, 0, '1', '{\"routePath\":\"\",\"title\":\"测试消息\",\"message\":\"1\",\"routePathTwo\":\"\"}', 1, 0, 0);
...
INSERT INTO `t_sys_role_menu` VALUES ('1567368770316419073', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1440255471893200897');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770316419074', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1461987433667141634');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770316419075', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1452091447254749186');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770329001986', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1452091513113710594');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770329001987', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1456054437146644481');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770329001988', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1440255602914869250');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770329001989', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1516699922710138882');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770333196290', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1516699798743289857');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770333196291', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1516699625820524545');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770333196292', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1440271162033684482');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770333196293', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1442156484086480897');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770333196294', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1459712656557576194');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770333196295', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1449764190750285826');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390594', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1462256665587916801');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390595', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1459850402525622274');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390596', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1451979503835369474');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390597', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1468415037767946242');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390598', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1462261436877152258');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390599', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1440256392576483330');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770337390600', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1440256481906769922');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770341584898', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1481642095692222465');
INSERT INTO `t_sys_role_menu` VALUES ('1567368770341584899', NULL, NULL, '2022-09-07 12:26:48', '2022-09-07 12:26:48', 0, 0, '1447115588580159489', '1450796419538522114');
...
INSERT INTO `t_sys_role_user` VALUES ('1567367009094615041', NULL, NULL, '2022-09-07 12:19:48', '2022-09-07 12:19:48', 0, 0, '1460427339745763329', '1447115588580159489');
INSERT INTO `t_sys_role_user` VALUES ('1567787993802997762', NULL, NULL, '2022-09-08 16:12:40', '2022-09-08 16:12:40', 0, 0, '685453406529261568', '1447115588580159489');
...
-- ----------------------------
INSERT INTO `t_sys_user` VALUES ('1', NULL, '0', '2020-08-05 07:11:04', '2022-09-09 15:46:50', 0, 10, 'admin', 'd9880822dd584adce3cde4b024776eef', 1, 0, '1548901388543594498,1548901468621246466,1548901576150618114', 0, 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/image/head/53206946-4.png', '10000', '平台主账号', '', 11, '2020-08-05 15:11:05', '2022-09-09 15:46:50', NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_user` VALUES ('1460427339745763329', '1', '0', '2021-11-16 09:59:45', '2022-09-07 13:29:06', 0, 0, 'test', '992171f4f472ae8360a32663d9529339', 2, 1, '1548901388543594498,1548901827913715713,1548901950412558337', 2, 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/image/head/22358982-11.jpg', '17600000001', 'Qqq', '0', 0, '2021-11-16 09:59:46', '2022-09-07 13:26:01', NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_user` VALUES ('685453406529261568', '1', '1', '2022-05-14 21:53:57', '2022-09-08 16:12:40', 0, 0, 'hexin', 'd508eefe214884b363bf33882afb4ed3', 0, 1, '1548901388543594498,1548901468621246466,1548901576150618114', 0, 'http://xijia-sz.oss-cn-shenzhen.aliyuncs.com/oss/file/image/head/25847053-8.jpg', '17600000000', '何鑫', '1', 20, '2022-05-14 21:53:57', '2022-06-17 13:53:52', NULL, NULL, NULL, NULL);
