...
import com.ws.ldy.baseadmin.service.impl.AuthorityAdminServiceImpl;
...
public class AuthorityAdminController extends BaseController {
    ...
    @ApiOperation("添加/修改")
    public ResponseData save(@PathVariable Integer type, AuthorityAdmin authorityAdmin) {
        if (type == 1) {
    ...
    public ResponseData putAuthority() {
        //获得到所有类
