package com.ws.ldy.modules.third.wechat.pay.controller;
...
import com.ws.ldy.modules.third.wechat.pay.wxApi.WxPayApi;
...
@RestController
@AllArgsConstructor
@Api(value = "WebsocketController", tags = "WX  -->  微信支付", consumes = BaseConstant.InterfaceType.PC_BASE)
...
//    }
    ...
    public R<WxPayOrderResultVO> createOrder(@RequestBody WxPayOrderDTO dto) throws WxPayException {
        WxPayOrderResultVO vo = this.xjWxPayService.createOrder(dto);
        return R.success(vo);
    }
