package com.ws.ldy.modules.third.websocket.controller;

import com.ws.ldy.common.result.R;
import com.ws.ldy.enums.BaseConstant;
import com.ws.ldy.modules.sys.base.controller.BaseController;
import com.ws.ldy.modules.third.websocket.model.vo.OnlineUserVO;
import com.ws.ldy.modules.third.websocket.service.WebsocketService;
...
@Api(value = "WebsocketController", tags = "Websocket  -->  消息通知/即时通讯",consumes = BaseConstant.InterfaceType.PC_BASE)
@RequestMapping(BaseConstant.Sys.API + "/websocket")
@RestController
@Slf4j
